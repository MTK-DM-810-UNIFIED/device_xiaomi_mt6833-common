...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.mediatek.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.mediatek.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.mediatek.rc \
    android.hardware.wifi@1.0-service.mediatek.xml
